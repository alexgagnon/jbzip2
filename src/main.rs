...
struct Cli {
    ...
    #[clap(parse(from_os_str), short = 'i', long = "input", required = false, takes_value = true, required = false, help = "Source file")]
    ...
    #[clap(short = 'j', long = "jq-filter", default_value = "", help = "jq filter, see https://jqlang.github.io/jq/ for usage. NOTE: items are provided to jq as an array.")]
    jq_filter: String,
    ...
    #[clap(short = 'd', long = "delimiter", help = "Delimiter between elements.")]
    delimiter: Option<String>,

    #[clap(short = 'b', long = "buffer-size", default_value = "1000000000", help = "the size of the buffer in bytes. NOTE: the buffer must be as large as the largest entity you're processing, and larger buffers are faster. Default is 1Gb.")]
    buffer_size: usize,
